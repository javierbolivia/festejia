    ...
    <BlockPreviewShell activo={activo} onClick={onClick}>
      <div className="pa-preview">
        ...
        <div className="pa-cols">
          <div><p className="pa-etiqueta">De la novia</p><p>{d.padres_novia || 'José Hernan Saavedra, Lizeth del Carmen Osinaga'}</p></div>
          <div><p className="pa-etiqueta">Del novio</p><p>{d.padres_novio || 'Julio Maldonado Apaza, Ruth Quispe Honorio'}</p></div>
        </div>
