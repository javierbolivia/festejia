// Plantilla A — "Mármol" (verde salvia y dorado, inspirada en la
// Plantilla 2 real del catálogo Premium: public/plantilla2/).
//
...
export default {
  id: 'plantilla-a',
  nombre: 'Mármol',
  paleta: { primario: '#5F6754', dorado: '#876E44' },
  bloques: [
  ...
  ordenReordenable: ['cuenta-regresiva', 'padres', 'ceremonia', 'recepcion', 'itinerario', 'galeria', 'musica', 'dress-code', 'solo-adultos', 'regalos', 'padrinos'],
}
