...
// Plantillas habilitadas para elegir al crear una invitación nueva.
// Por ahora solo 'plantilla-a' (Mármol, inspirada en la Plantilla 2 real
// del catálogo Premium) está disponible como ejemplo funcionando con el
// editor de bloques. Las demás quedan definidas en lib/express/templates/
// para cuando se agreguen más adelante, pero no se ofrecen todavía.
export const PLANTILLAS_EXPRESS = ['plantilla-a']
